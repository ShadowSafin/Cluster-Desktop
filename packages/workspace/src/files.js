...
export function gitignoreToGlobPatterns(gitignore) {
    const out = [];
...
export async function loadIgnorePatterns(root) {
...
export async function listDirectory(root, relativePath = '.', options = {}) {
